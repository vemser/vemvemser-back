...
//    public void deveTestarCadastrarComFormularioIncorreto() {
//        CandidatoCreateDto candidatoCreateDto = getCandidatoCreateDto();
//
//        CandidatoEntity candidatoEntity = getCandidatoEntity();
//
...
//
//        Integer formulario = new FormularioEntity().getIdFormulario().compareTo(1);
//        when(candidatoRepository.save(any())).thenReturn(candidatoCreateDto);
//
//        //Ação(ACT)
//        candidatoService.cadastro(formulario);
//
//    }
